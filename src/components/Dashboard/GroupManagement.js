    ...
    <div className="container mt-4">
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <button onClick={handleAddGroup} className="btn btn-primary">
          {showAddContainer ? 'Close' : 'Add Group'}
        </button>
      </div>
      ...
      {!showAddContainer && (
        <div>
          <GroupList
            groups={groups} selectedGroup={selectedGroup} handleGroupClick={handleGroupClick}
            handleRemoveUser={handleRemoveUser} removeError={removeError} userRemoveMessage={userRemoveMessage}
            handleAddNewUser={handleAddNewUser} addError={addError} userAddMessage={userAddMessage}
